	        ...
	        <div class="box">
	            ...
	            <ul class="list no-border p-b">
	              <li class="list-item">
	                <a herf class="list-left">
	                	<span class="w-40 avatar">
		                  <img src="<?php echo base_url(); ?>assets/assetsbus/images/a4.jpg" alt="...">
		                  <i class="on b-white bottom"></i>
	                    </span>
	                </a>
	                <div class="list-body">
	              ...
	              <li class="list-item">
	                <a herf class="list-left">
	                  <span class="w-40 avatar">
		                  <img src="<?php echo base_url(); ?>assets/assetsbus/images/a5.jpg" alt="...">
		                  <i class="on b-white bottom"></i>
	                  </span>
	                </a>
	                <div class="list-body">
	              ...
	              <li class="list-item">
	                <a herf class="list-left">
	                  <span class="w-40 avatar">
		                  <img src="<?php echo base_url(); ?>assets/assetsbus/images/a6.jpg" alt="...">
	              ...
	              <li class="list-item">
	                <a herf class="list-left">
	                  <span class="w-40 avatar">
		                  <img src="<?php echo base_url(); ?>assets/assetsbus/images/a7.jpg" alt="...">
	    ...
	    <div class="col-sm-12 col-md-4">
	    	<div class="box">
				...
				<div class="box-body">
		              ...
		              <div class="sl-item">
		                <div class="sl-left">
		                  <img src="<?php echo base_url(); ?>assets/assetsbus/images/a2.jpg" class="img-circle">
		                </div>
		                <div class="sl-content">
		              ...
		              <div class="sl-item">
		                <div class="sl-left">
		                  <img src="<?php echo base_url(); ?>assets/assetsbus/images/a5.jpg" class="img-circle">
		                </div>
		                <div class="sl-content">
		              ...
		              <div class="sl-item">
		                <div class="sl-left">
		                  <img src="<?php echo base_url(); ?>assets/assetsbus/images/a8.jpg" class="img-circle">
		                </div>
		                <div class="sl-content">
